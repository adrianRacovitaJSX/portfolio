          ...
          <Body className="bg-gray-50">
            <Container className="p-8 max-w-xl bg-white rounded-lg shadow">
              ...
              <Text className="text-gray-700 mb-6">
                He recibido tu mensaje y me pondré en contacto contigo en las próximas 24 horas para discutir los detalles de tu proyecto.
              </Text>
  
              <Section className="mb-6">
                <Text className="text-sm font-medium text-gray-700 mb-1">Resumen de tu mensaje:</Text>
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <Text className="font-semibold text-gray-800 mb-1">Tu mensaje:</Text>
              ...
              <Text className="text-gray-700 mb-6">
                Si necesitas hacer alguna modificación o tienes información adicional, no dudes en responder a este email.
              </Text>
